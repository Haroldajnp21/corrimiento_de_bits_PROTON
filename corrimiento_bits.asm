...
proton#main#start
    bcf STATUS,PP_RP0
    bcf STATUS,PP_RP1
F1_SOF equ $ ; CORRIMIENTO_BITS.BAS
    bsf STATUS,5
    bsf STATUS,6
ram_bank = 3
    clrf ANSEL
...
ram_bank = 2
    clrf CM1CON0
    clrf CM2CON0
F1_000020 equ $ ; IN [CORRIMIENTO_BITS.BAS] TRISA=0
    bsf STATUS,5
    bcf STATUS,6
ram_bank = 1
    clrf TRISA
F1_000021 equ $ ; IN [CORRIMIENTO_BITS.BAS] TRISB=0
    clrf TRISB
F1_000022 equ $ ; IN [CORRIMIENTO_BITS.BAS] TRISC=0
    clrf TRISC
F1_000023 equ $ ; IN [CORRIMIENTO_BITS.BAS] ANSEL=0
    bsf STATUS,6
ram_bank = 3
    clrf ANSEL
F1_000024 equ $ ; IN [CORRIMIENTO_BITS.BAS] ANSELH=0
    clrf ANSELH
F1_000026 equ $ ; IN [CORRIMIENTO_BITS.BAS] PORTB=0
    bcf STATUS,5
    bcf STATUS,6
ram_bank = 0
    clrf PORTB
F1_000027 equ $ ; IN [CORRIMIENTO_BITS.BAS] PORTC=0
    clrf PORTC
F1_000031 equ $ ; IN [CORRIMIENTO_BITS.BAS] LED =1
    movlw 0X01
    movwf PORTC
Inicio
F1_000033 equ $ ; IN [CORRIMIENTO_BITS.BAS] LED =1
    movlw 0X01
    movwf PORTC
F1_000034 equ $ ; IN [CORRIMIENTO_BITS.BAS] DELAYMS 200
    movlw 0XC8
    f@call __delay_ms_
ram_bank = 0
F1_000035 equ $ ; IN [CORRIMIENTO_BITS.BAS] FOR I=0 TO 7
    clrf _I
_frlb__2
    movlw 0X08
    subwf _I,W
    ...
    btfsc STATUS,0
    goto _nxlb__3
F1_000036 equ $ ; IN [CORRIMIENTO_BITS.BAS] LED = LED<<1
    bcf STATUS,0
    rlf PORTC,F
F1_000037 equ $ ; IN [CORRIMIENTO_BITS.BAS] DELAYMS 200
    movlw 0XC8
    f@call __delay_ms_
ram_bank = 0
_ctlb__4
F1_000038 equ $ ; IN [CORRIMIENTO_BITS.BAS] NEXT I
    movlw 0X01
    addwf _I,F
    set@page _frlb__2
    btfss STATUS,0
    goto _frlb__2
_nxlb__3
F1_000039 equ $ ; IN [CORRIMIENTO_BITS.BAS] GOTO INICIO
    f@jump Inicio
F1_000041 equ $ ; IN [CORRIMIENTO_BITS.BAS] END
_pblb__5
    f@jump _pblb__5
F1_EOF equ $ ; CORRIMIENTO_BITS.BAS
_pblb__6
    f@jump _pblb__6
__EOF
